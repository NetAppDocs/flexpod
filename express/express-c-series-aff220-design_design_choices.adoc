...
For more information about the AFF A220 hardware system, see the https://www.netapp.com/aff-a-series/[AFF A-Series homepage^].
...
image:express-c-series-aff220-design_image5.png["A diagram that shows multiple 4KB logical blocks compacted into one 4KB physical block"]
...
image:express-c-series-aff220-design_image6.png["A diagram that shows disks partitioned into root, Controller 1, and Controller 2 partitions"]

These are just a few key features that complement the FlexPod Express solution. For details about the additional features and functionality of ONTAP 9.4, see the https://www.netapp.com/pdf.html?item=/media/7413-ds-3231-ontap-unified-data-storage-management.pdf[ONTAP 9 Data Management Software datasheet^]. Also, see the NetApp http://docs.netapp.com/ontap-9/index.jsp[ONTAP 9 Documentation Center^], which has been updated to include ONTAP 9.4.
...
image:express-c-series-aff220-design_image7.png["A screenshot that shows the front view of a Cisco Nexus 3172 switch with network ports"]
...
image:express-c-series-aff220-design_image8.png["A front view of a Cisco UCS C220 M5 rack server with dual drive bays and Cisco branding"]
...
image:express-c-series-aff220-design_image9.png["A Cisco UCS VIC 1387 adapter card with dual QSFP+ ports and a cooling fan"]
...
image:express-c-series-aff220-design_image10.png["A photograph of a Cisco CVR-QSFP-SFP10G QSFP-to-SFP adapter module"]
