...
image:express-c-series-aff220-deploy_image3.png["A diagram that compares FlexPod Express, Datacenter, and Select solutions, targets, and infrastructure components"]
...
image:express-c-series-aff220-deploy_image4.png["A diagram that shows Cisco Nexus 3172P switches, UCS C220 M5 servers, and AFF A220 storage connectivity"]
