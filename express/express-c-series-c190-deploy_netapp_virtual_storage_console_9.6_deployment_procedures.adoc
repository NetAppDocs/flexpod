...
+
image:express-c-series-c190-deploy_image49.png["A screenshot of vSphere Client Deploy OVF Template with a VSC OVF file selected in the Open dialog"]

. Enter the VM name and select a datacenter or folder in which to deploy. Click Next.
+
image:express-c-series-c190-deploy_image50.png["A screenshot of the Deploy OVF Template wizard with VM name FlexPod-VSC and FlexPod-Datacenter selected"]

. Select the FlexPod-Cluster ESXi cluster and click Next.
. Review the details and click Next.
+
image:express-c-series-c190-deploy_image51.png["A screenshot that shows the Review details step for deploying the NetApp VSC virtual appliance OVF template"]
...
+
image:express-c-series-c190-deploy_image52.png["A screenshot of the Deploy OVF Template Select storage page with Thin Provision and NFS datastores"]

. From Select Networks, choose a destination network and click Next.
+
image:express-c-series-c190-deploy_image53.png["A screenshot of the Deploy OVF Template Select networks step mapping nat to MGMT-Network"]
...
+
image:express-c-series-c190-deploy_image54.png["A screenshot of the Deploy OVF Template Customize template page with vCenter registration fields and Network Properties"]
...
+
image:express-c-series-c190-deploy_image55.png["A VM console showing instructions to install VMware Tools before continuing VSC, VASA Provider, and SRA installation"]
...
+
image:express-c-series-c190-deploy_image56.png["A screenshot of the vSphere Client Menu with Virtual Storage Console highlighted"]
...
+
image:express-c-series-c190-deploy_image57.png["A screenshot of VSC NFS VAAI Tools with a NetAppNasPlugin.vib file selected for upload"]
...
+
image:express-c-series-c190-deploy_image58.png["A screenshot that shows the NetApp VSC menu with Install NFS Plug-in for VMware VAAI selected"]
...
+
image:express-c-series-c190-deploy_image59.png["A screenshot of the vSphere Client host Actions menu with NetApp VSC Set Recommended Values selected"]

. Check the settings that you would like to apply to the selected vSphere hosts. Click OK to apply the settings.
+
image:express-c-series-c190-deploy_image60.png["A Set Recommended Values dialog with selected HBA/CNA Adapter, MPIO, and NFS settings"]
+
image:express-c-series-c190-deploy_image61.png["A Success dialog stating modified ESXi host settings appear after successful storage system discovery"]
