...
image:express-c-series-aff220-deploy_image5.png["A diagram that shows Cisco Nexus switches, Cisco UCS servers, and NetApp AFF A220 controllers with 10GbE ports highlighted"]
