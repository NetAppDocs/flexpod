...
image:express-c-series-aff220-design_image2.png["A diagram that shows FlexPod Express, Datacenter, and Select platforms with target deployments and components"]
