...
+
image:express-c-series-c190-deploy_image17.png["A screenshot of the Cisco CIMC Server BIOS page with the Launch KVM link in the top menu"]
...
+
image:express-c-series-c190-deploy_image18.png["A screenshot of the ESXi installer selecting a NETAPP LUN C-Mode storage device with 15.00 GiB capacity"]
...
+
image:express-c-series-c190-deploy_image19.png["A screenshot of the ESXi Network Adapters screen with vmnic2 and vmnic4 selected for management networking"]
...
+
image:express-c-series-c190-deploy_image20.png["A screenshot of the ESXi Networking page with the Virtual switches tab showing vSwitch0 and iScsiBootvSwitch"]
...
+
image:express-c-series-c190-deploy_image21.png["A screenshot of iSCSIBootPG-A teaming and failover settings with vmnic3 active and vmnic5 unused"]
...
+
image:express-c-series-c190-deploy_image22.png["A screenshot of the ESXi Storage Adapters tab with the iSCSI software adapter vmhba64 selected"]

. Under Dynamic Targets, click Add Dynamic Target.
+
image:express-c-series-c190-deploy_image23.png["A screenshot that shows iSCSI dynamic targets with four IP addresses and port 3260 configured"]

. Enter the IP address `iscsi_lif01a`.
.. Repeat with the IP addresses `iscsi_lif01b`, `iscsi_lif02a`, and `iscsi_lif02b`.
.. Click Save Configuration.
+
image:express-c-series-c190-deploy_image24.png["A screenshot of four iSCSI dynamic target addresses using port 3260 and the Save Configuration button"]
+
[NOTE]
...
. Select vSwitch0.
+
image:express-c-series-c190-deploy_image25.png["A screenshot of the ESXi vSwitch0 page showing MTU 9000 and active vmnic2 and vmnic4 adapters"]
...
+
image:express-c-series-c190-deploy_image26.png["A screenshot of the ESXi Networking page with the Port groups tab selected and Add port group available"]
...
+
image:express-c-series-c190-deploy_image27.png["A screenshot of the ESXi Networking VMkernel NICs tab listing vmk0 and vmk1 interfaces"]
...
+
image:express-c-series-c190-deploy_image28.png["A screenshot of the Add VMkernel NIC dialog with static IPv4 settings and vMotion selected"]
+
[NOTE]
...
+
image:express-c-series-c190-deploy_image29.png["A screenshot of the VMware ESXi Storage page with the New datastore button visible"]

. Select Mount NFS Datastore.
+
image:express-c-series-c190-deploy_image30.png["A screenshot of the New datastore wizard with Mount NFS datastore selected as the creation type"]
...
. Click Save.
+
image:express-c-series-c190-deploy_image31.png["A screenshot that shows ESXi Time & date settings with NTP service running and three NTP servers"]
...
+
image:express-c-series-c190-deploy_image32.png["A screenshot of the VMware ESXi Manage System Swap page with swap settings displayed"]

. Click Edit Settings. Select `infra_swap` from the Datastore options.
+
image:express-c-series-c190-deploy_image33.png["A screenshot of the Edit swap configuration dialog with infra_swap selected as the datastore and Save and Cancel buttons"]
