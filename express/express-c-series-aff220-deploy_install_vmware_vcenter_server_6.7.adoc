...
+
image:express-c-series-aff220-deploy_image41.png["A screenshot of the VMware ESXi Host page with the Get vCenter Server button highlighted"]
...
+
image:express-c-series-aff220-deploy_image42.png["A screenshot of the vCenter Server Appliance deployment type selection with Embedded Platform Services Controller selected"]
+
[NOTE]
...
+
image:express-c-series-aff220-deploy_image43.png["A screenshot of the vCenter Server appliance deployment target page with ESXi host, port, root user, and password fields"]

. Set the appliance VM by entering `VCSA` as the VM name and the root password you would like to use for the VCSA.
+
image:express-c-series-aff220-deploy_image44.png["A screenshot of the Set up appliance VM page with VM name and root password fields"]

. Select the deployment size that best fits your environment. Click Next.
+
image:express-c-series-aff220-deploy_image45.png["A screenshot of the vCenter Server deployment size page with Tiny and Default storage selected"]

. Select the infra_datastore_1 datastore. Click Next.
+
image:express-c-series-aff220-deploy_image46.png["A screenshot of the vCenter Server installer Select datastore page with infra_datastore_1 selected"]
...
+
image:express-c-series-aff220-deploy_image47.png["A screenshot of vCenter Server Appliance Installer Configure network settings with static IPv4 fields populated"]
+
...
+
image:express-c-series-aff220-deploy_image48.png["A screenshot of the vCenter Server Appliance Stage 2 Introduction page with a Next button"]
