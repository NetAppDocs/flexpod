...
. Click OK.
+
image:express-c-series-c190-deploy_image45.png["A screenshot of the New Cluster dialog with DRS and vSphere HA enabled and vSAN disabled"]
...
+
image:express-c-series-c190-deploy_image46.png["A screenshot of the vSphere Client Add hosts wizard with a host FQDN entry field and Next button"]
...
. Log in to `https://<vCenter IP>:5480`, enter root for the user name, and enter the root password.
. Click on services and select VMware vSphere ESXI Dump collector.
. Start the VMware vSphere ESXI Dump collector service.
+
image:express-c-series-c190-deploy_image47.png["A screenshot of Appliance Management Services with VMware vSphere ESXi Dump Collector selected and Start available"]
...
+
image:express-c-series-c190-deploy_image48.png["A terminal showing ESXi coredump configuration commands and netdump server verification"]
+
[NOTE]
