...
image:express-c-series-c190-design_image4.png["A diagram that shows rear views of two AFF C190 controllers with UTA 2 ports for SFP+ modules"]

The following figure illustrates 10GBASE-T ports for connection through conventional RJ-45 Ethernet cables.

image:express-c-series-c190-design_image5.png["A diagram that shows the rear panel of an AFF C190 system with 10GBASE-T RJ-45 ports"]
...
For full information about the AFF C190 hardware system, see the https://docs.netapp.com/us-en/ontap-systems/c190/install-setup.html[NetApp AFF C190 documentation^].
...
image:express-c-series-c190-design_image6.png["A diagram that shows multiple 4KB logical blocks compacted into one 4KB physical block"]
...
image:express-c-series-c190-design_image7.png["A front view of a Cisco Nexus 31108PC-V switch with 48 SFP+ ports and six QSFP28 ports"]
...
image:express-c-series-c190-design_image8.png["A front view of a Cisco UCS C220 M5 rack server with dual drive bays and Cisco branding"]
...
image:express-c-series-c190-design_image9.png["A screenshot of the Cisco UCS VIC 1457 adapter with four SFP28 ports and a cooling fan"]
...
image:express-c-series-c190-design_image10.png["A diagram that shows four vNICs connected to FlexPod and iSCSI boot vSwitches on a VMware ESXi 6.7 U2 host"]
