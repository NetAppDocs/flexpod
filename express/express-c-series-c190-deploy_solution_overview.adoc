...
image:express-c-series-c190-deploy_image1.png["A diagram that shows FlexPod Express and FlexPod Datacenter portfolio options with use cases"]
...
image:express-c-series-c190-deploy_image2.png["A diagram that shows FlexPod Express switches, C220 M5 servers, and AFF C190 storage connections"]
