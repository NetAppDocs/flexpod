...
Follow the physical installation procedures for the controllers in the https://docs.netapp.com/us-en/ontap-systems/a220/install-setup.html[AFF A220 Documentation^].
...
+
image:express-direct-attach-aff220-deploy_image7.png["A screenshot of the Create Block of IPv4 Addresses dialog with IP address, subnet, gateway, and DNS fields"]
...
+
image:express-direct-attach-aff220-deploy_image8.png["A screenshot of the Add NTP Server dialog with NTP Server set to 10.1.156.4"]

. Click Add NTP Server.
. Enter `<switch-b-ntp-ip>` `or <Nexus-B-mgmt-IP>` and click OK. Click OK on the confirmation.
+
image:express-direct-attach-aff220-deploy_image9.png["A screenshot of Cisco UCS Manager NTP settings with two NTP servers listed and the America/New_York time zone selected"]
...
+
image:express-direct-attach-aff220-deploy_image10.png["A screenshot that shows Fabric Interconnect A Ethernet ports with uplink and appliance storage roles configured"]
...
+
image:express-direct-attach-aff220-deploy_image11.png["A screenshot that shows Fabric Interconnect B Ethernet ports with network and appliance storage roles configured"]
...
. Click Next.
+
image:express-direct-attach-aff220-deploy_image12.png["A screenshot of the Create Port Channel dialog with ID 1 and name vPC-13-Nexus entered"]
...
+
image:express-direct-attach-aff220-deploy_image13.jpeg["A screenshot of the Create VLANs dialog with NFS-VLAN and VLAN ID 3170 entered"]
...
. Click OK, and then click OK again to create the VLAN.
+
image:express-direct-attach-aff220-deploy_image14.png["A screenshot that shows the VLANs table in Cisco UCS Manager with VLAN names and IDs"]
...
+
image:express-direct-attach-aff220-deploy_image15.png["A screenshot that shows the Enable_CDP network control policy with CDP and LLDP transmit and receive enabled"]
...
+
image:express-direct-attach-aff220-deploy_image16.png["A screenshot of Appliance Interface 1/3 properties with CDP enabled and storage VLANs selected"]
...
+
image:express-direct-attach-aff220-deploy_image17.png["A screenshot of Appliance Interface 1/3 VLAN settings with iSCSI-B, NFS, and Native VLANs selected"]
...
+
image:express-direct-attach-aff220-deploy_image18.png["A screenshot of Cisco UCS Manager QoS System Class settings with Best Effort MTU set to 9216"]
...
+
image:express-direct-attach-aff220-deploy_image19.png["A screenshot of the Modify Package Versions dialog with Blade Package 4.0(1b)B selected"]
...
+
image:express-direct-attach-aff220-deploy_image20.png["A screenshot of the Create a Block of MAC Addresses dialog with MAC address 00:25:B5:32:0A:00 and size 64"]
...
+
image:express-direct-attach-aff220-deploy_image21.png["A screenshot of the Create a Block of IQN Suffixes dialog with suffix ucs-host, From 1, and Size 16"]
...
+
image:express-direct-attach-aff220-deploy_image22.png["A screenshot of the Create Network Control Policy dialog with CDP and LLDP enabled"]
...
+
image:express-direct-attach-aff220-deploy_image23.png["A screenshot of the Create Power Control Policy dialog with No-Power-Cap and No Cap selected"]
...
+
image:express-direct-attach-aff220-deploy_image24.png["A screenshot of Cisco UCS Manager Create CPU/Cores Qualification dialog with Xeon processor architecture and CPU PID field"]
...
+
image:express-direct-attach-aff220-deploy_image25.png["A screenshot of the Create BIOS Policy dialog with VM-Host name and Consistent Device Naming enabled"]
...
+
image:express-direct-attach-aff220-deploy_image26.png["A screenshot of the Create BIOS Policy Processor tab with Processor C State and C1E disabled"]
...
+
image:express-direct-attach-aff220-deploy_image27.png["A screenshot that shows BIOS Processor options with Energy Performance and DRAM Clock Throttling set to performance"]

. Click RAS Memory and set the following parameters:
** LV DDR Mode: performance mode
+
image:express-direct-attach-aff220-deploy_image28.png["A screenshot of the Create BIOS Policy RAS Memory page with LV DDR Mode set to Performance Mode"]
...
+
image:express-direct-attach-aff220-deploy_image29.png["A screenshot of the Cisco UCS Manager default maintenance policy with User Ack and On Next Boot selected"]
...
. Click OK.
+
image:express-direct-attach-aff220-deploy_image30.png["A screenshot of Cisco UCS Manager vNIC template properties for vNIC_Template_A on Fabric A"]
...
. Click OK.
+
image:express-direct-attach-aff220-deploy_image31.png["A screenshot of Cisco UCS Manager vNIC Template B settings with Fabric B, MTU 9000, and MAC Pool B selected"]
...
. Click OK.
+
image:express-direct-attach-aff220-deploy_image32.png["A screenshot of the Site_01_iSCSI-A vNIC template with Fabric A, MTU 9000, and MAC Pool A56/64 selected"]
...
. Click OK.
+
image:express-direct-attach-aff220-deploy_image33.png["A screenshot of Cisco UCS Manager vNIC template Site_01_iSCSI-B settings for Fabric B with MTU 9000"]
...
+
image:express-direct-attach-aff220-deploy_image34.png["A screenshot that shows the Modify vNIC dialog for Site-01-vNIC-A using vNIC_Template_A and VMWare adapter policy"]
...
+
image:express-direct-attach-aff220-deploy_image35.png["A screenshot of the Modify iSCSI vNIC dialog for Site-01-iSCSI-A with VLAN and MAC address settings"]
...
. Click Save Changes.
+
image:express-direct-attach-aff220-deploy_image36.png["A screenshot of the Site-01-iSCSIBoot LAN connectivity policy with two iSCSI vNICs listed"]
...
+
This VMware ESXi 6.7U1 ISO can be downloaded from https://support.broadcom.com/group/ecx/downloads[Broadcom support portal^].
...
+
image:express-direct-attach-aff220-deploy_image37.png["A screenshot of the Create vMedia Mount dialog configured with an HTTP ESXi installer ISO remote file and path"]
...
+
image:express-direct-attach-aff220-deploy_image38.png["A screenshot of Cisco UCS Manager Boot Policy Site-01-Fabric-A with two iSCSI boot entries configured"]
...
+
image:express-direct-attach-aff220-deploy_image39.png["A screenshot of the Create Service Profile Template wizard with name, updating template, and UUID pool fields"]
...
+
image:express-direct-attach-aff220-deploy_image40.png["A screenshot of Create Service Profile Template networking settings with iSCSI-Boot connectivity and IQN_Pool selected"]
...
+
image:express-direct-attach-aff220-deploy_image41.png["A screenshot of the Create Service Profile Template Server Boot Order page with Boot-Fabric-A selected"]
...
+
image:express-direct-attach-aff220-deploy_image42.png["A screenshot of the iscsi show command output listing an Infra-SVM target IQN, alias, and up status"]

. Enter the IP address of `iscsi_lif_02a` for the IPv4 Address field.
+
image:express-direct-attach-aff220-deploy_image43.png["A screenshot of the Create iSCSI Static Target dialog with IPv4 address 192.168.10.62 entered"]
...
+
image:express-direct-attach-aff220-deploy_image44.png["A screenshot of the Create iSCSI Static Target dialog with IPv4 address 192.168.10.61 and LUN ID 0"]

. Click OK to add the iSCSI static target.
+
image:express-direct-attach-aff220-deploy_image45.png["A screenshot of the Set iSCSI Boot Parameters dialog with iSCSI static target interfaces selected"]
+
[NOTE]
...
+
image:express-direct-attach-aff220-deploy_image46.png["A screenshot of the Create iSCSI Static Target dialog with IPv4 Address set to 192.168.20.62"]
...
+
image:express-direct-attach-aff220-deploy_image47.png["A screenshot of the Create iSCSI Static Target dialog with IPv4 address 192.168.20.61 and LUN ID 0"]

. Click OK to add the iSCSI static target.
+
image:express-direct-attach-aff220-deploy_image48.png["A screenshot that shows two iSCSI static target interfaces selected in Set iSCSI Boot Parameters"]
...
+
image:express-direct-attach-aff220-deploy_image49.png["A screenshot of the Create Service Profile Template Maintenance Policy step with the default policy selected"]
...
+
image:express-direct-attach-aff220-deploy_image50.png["A screenshot of Create Service Profile Template Server Assignment with Infra-Pool, Down power state, and default firmware package selected"]
...
+
image:express-direct-attach-aff220-deploy_image51.png["A screenshot of the Create Service Profile Template Operational Policies page with VM-Host BIOS and No-Power-Cap selected"]
...
+
image:express-direct-attach-aff220-deploy_image52.png["A screenshot of the Create Service Profiles From Template dialog with prefix Site-01-Infra-0, number 2, and root organization"]
...
. Log in to Broadcom support portal download site: https://support.broadcom.com/group/ecx/downloads[https://support.broadcom.com/group/ecx/downloads^].
. You will need a Broadcom user ID and password. Look for VMware vSphere Hypervisor (ESXi) Custom ISOs.
. Download the Cisco Custom Image for ESXi 6.7U1 Install CD.
...
. Press Enter.
+
image:express-direct-attach-aff220-deploy_image53.png["A screenshot of the ESXi Network Adapters screen with vmnic0 and vmnic1 selected and connected"]
...
+
image:express-direct-attach-aff220-deploy_image54.png["A screenshot that shows vSwitch0 details and topology with VMkernel adapters and two physical adapters"]
...
+
image:express-direct-attach-aff220-deploy_image55.png["A screenshot of the ESXi VMkernel NICs tab listing five VMkernel adapters and their port groups"]
...
+
image:express-direct-attach-aff220-deploy_image56.png["A screenshot of the ESXi Storage Adapters tab with the iSCSI software adapter vmhba64 selected"]
...
+
image:express-direct-attach-aff220-deploy_image57.png["A screenshot of the Configure iSCSI dialog showing four dynamic and static iSCSI targets on port 3260"]
+
...
+
image:express-direct-attach-aff220-deploy_image58.png["A screenshot of the New datastore wizard with Mount NFS datastore selected as the creation type"]
...
.. Click Next.
+
image:express-direct-attach-aff220-deploy_image59.png["A screenshot of the Provide NFS mount details page with infra_datastore_1 and NFS server 192.168.104.3"]
...
. Click Finish. The datastore should now appear in the datastore list.
+
image:express-direct-attach-aff220-deploy_image60.jpeg["A screenshot of the ESXi Storage datastore list showing infra_datastore_2 mounted as an NFS datastore"]
...
+
image:express-direct-attach-aff220-deploy_image61.png["A screenshot of the Edit time configuration dialog with NTP enabled and two NTP server addresses entered"]
...
+
image:express-direct-attach-aff220-deploy_image62.png["A screenshot of the VMware ESXi Manage System Swap page showing swap settings and Edit settings"]

. Click Edit Settings. Select `infra_swap` from the Datastore options.
+
image:express-direct-attach-aff220-deploy_image63.png["A screenshot of the Edit swap configuration dialog with the infra_swap datastore selected and Save and Cancel buttons"]
...
+
image:express-direct-attach-aff220-deploy_image64.png["A screenshot of the ESXi Host navigator with the Get vCenter Server button highlighted"]
...
+
image:express-direct-attach-aff220-deploy_image65.png["A screenshot of the vCenter Server Appliance Installer Select deployment type page with Embedded Platform Services Controller selected"]
+
...
+
image:express-direct-attach-aff220-deploy_image66.png["A screenshot of the VCenter Server Appliance Installer Appliance deployment target page with ESXi host credentials entered"]

. Set the appliance VM by entering VCSA as the VM name and the root password you would like to use for the VCSA. Click Next.
+
image:express-direct-attach-aff220-deploy_image67.png["A screenshot of the vCenter Server Appliance Installer Set up appliance VM page with VM name and root password fields"]

. Select the deployment size that best fits your environment. Click Next.
+
image:express-direct-attach-aff220-deploy_image68.png["A screenshot of the vCenter Server Appliance Installer Select deployment size page with Tiny selected"]

. Select the `infra_datastore_1` datastore. Click Next.
+
image:express-direct-attach-aff220-deploy_image69.png["A screenshot of the vCenter Server Appliance Installer Select datastore page with infra_datastore_1 listed among three datastores"]
...
+
image:express-direct-attach-aff220-deploy_image70.png["A screenshot of the vCenter Server Appliance Installer Configure network settings page with static IPv4 details"]
...
+
image:express-direct-attach-aff220-deploy_image71.png["A screenshot that shows successful Stage 1 vCenter Server deployment with a Continue button"]
...
. Click OK.
+
image:express-direct-attach-aff220-deploy_image72.png["A screenshot of the New Cluster dialog with DRS and vSphere HA enabled for the Express cluster"]
...
+
image:express-direct-attach-aff220-deploy_image73.png["A screenshot of the vSphere Client Actions menu for the Express cluster with Add Hosts selected"]
