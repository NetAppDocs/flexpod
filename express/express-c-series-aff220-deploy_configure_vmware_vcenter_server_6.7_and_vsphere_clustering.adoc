...
. Click OK.
+
image:express-c-series-aff220-deploy_image49.png["A screenshot of the New Cluster dialog with DRS and vSphere HA enabled for cluster Tiger3"]

== Add ESXi hosts to cluster

. Right-click the cluster and select Add Host.
+
image:express-c-series-aff220-deploy_image50.png["A screenshot of the vSphere Web Client showing the FlexPod cluster Actions menu with Add Host selected"]
