...
image:express-c-series-aff220-design_image3.png["A diagram that shows FlexPod Express storage, switching, and compute hardware families with configuration options"]
...
image:express-c-series-aff220-design_image4.png["A diagram that shows Cisco Nexus 3172P switches, UCS C220 M5 servers, and AFF A220 storage connectivity"]
