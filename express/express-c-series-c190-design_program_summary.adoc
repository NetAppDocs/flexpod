...
image:express-c-series-c190-design_image1.png["A diagram that compares FlexPod Express departmental deployments with FlexPod Datacenter mission-critical workloads"]
...
image:express-c-series-c190-design_image2.png["A diagram that shows FlexPod Express storage, switch, and server hardware options"]
...
image:express-c-series-c190-design_image3.png["A diagram that shows FlexPod Express switches, C220 M5 servers, and AFF C190 storage connections"]
