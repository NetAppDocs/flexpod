...
+
image:express-c-series-aff220-deploy_image6.png["A screenshot of System Manager Guided Setup cluster configuration fields for two HA pair nodes and licenses"]
...
+
image:express-c-series-aff220-deploy_image7.png["A screenshot of OnCommand System Manager Support setup with AutoSupport and event notification fields"]
