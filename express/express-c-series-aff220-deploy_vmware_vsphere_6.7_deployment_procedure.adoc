...
+
image:express-c-series-aff220-deploy_image21.png["A screenshot of the Cisco CIMC Server BIOS page with the Launch KVM link in the top menu"]
...
. Navigate to the https://support.broadcom.com/group/ecx/downloads[Broadcom support portal download site^] for custom ISOs.
...
+
image:express-c-series-aff220-deploy_image22.png["A screenshot of the ESXi installer selecting a NETAPP LUN C-Mode storage device with 15.00 GiB capacity"]
...
+
image:express-c-series-aff220-deploy_image23.png["A screenshot of the ESXi Network Adapters menu with vmnic0 and vmnic1 selected for vSwitch0"]
...
+
image:express-c-series-aff220-deploy_image24.png["A screenshot of the ESXi Networking Virtual switches tab showing vSwitch0 and iScsiBootvSwitch"]
...
** Click Create.
+
image:express-c-series-aff220-deploy_image25.png["A screenshot of the Add VMkernel NIC form configuring iScsiBootPG-B with static IPv4 settings and MTU 9000"]
+
[NOTE]
...
+
image:express-c-series-aff220-deploy_image26.png["A screenshot of the VMware ESXi Storage Adapters page with the iSCSI software adapter vmhba64 selected"]

. Under Dynamic Targets, click Add Dynamic Target.
+
image:express-c-series-aff220-deploy_image27.png["A screenshot of the Configure iSCSI dialog with Add dynamic target under Dynamic targets"]
...
+
image:express-c-series-aff220-deploy_image28.png["A screenshot that shows four iSCSI dynamic target IP addresses, each using port 3260"]
...
. Select vSwitch0.
+
image:express-c-series-aff220-deploy_image29.png["A screenshot of the VMware ESXi vSwitch0 page showing MTU 1500 and two active physical adapters"]
...
+
image:express-c-series-aff220-deploy_image30.png["A screenshot of the ESXi Networking page with the Port groups tab selected and Add port group available"]
...
+
image:express-c-series-aff220-deploy_image31.png["A screenshot of the ESXi Networking VMkernel NICs tab listing vmk0 and vmk1 adapters"]
...
** Click Create.
+
image:express-c-series-aff220-deploy_image32.png["A screenshot of the Add VMkernel NIC form configuring the NFS-Network port group with static IPv4 settings"]
...
+
image:express-c-series-aff220-deploy_image33.png["A screenshot of the Add VMkernel NIC dialog with static IPv4 settings and vMotion selected"]
+
[NOTE]
...
+
image:express-c-series-aff220-deploy_image34.png["A screenshot of the VMware ESXi Storage page with the New datastore button visible"]

. Select Mount NFS Datastore.
+
image:express-c-series-aff220-deploy_image35.png["A screenshot of the New datastore wizard with Mount NFS datastore selected as the creation type"]
...
+
image:express-c-series-aff220-deploy_image36.png["A screenshot of the ESXi Manage System Time & date page showing NTP client status and NTP servers"]
...
. Click Save.
+
image:express-c-series-aff220-deploy_image37.png["A screenshot of the Edit time configuration dialog with NTP enabled and an NTP server entered"]
...
+
image:express-c-series-aff220-deploy_image38.png["A screenshot of the VMware ESXi Manage System Swap page with swap settings displayed"]

. Click Edit Settings. Select infra_swap from the Datastore options.
+
image:express-c-series-aff220-deploy_image39.png["A screenshot of the Edit swap configuration dialog with infra_swap selected as the datastore and Save and Cancel buttons"]
...
+
image:express-c-series-aff220-deploy_image40.png["A terminal showing successful NetApp NFS Plug-in VIB installation and a reboot required message"]
