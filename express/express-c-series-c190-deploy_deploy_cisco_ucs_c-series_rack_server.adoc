...
+
image:express-c-series-c190-deploy_image5.png["A screenshot that shows a Cisco server boot screen prompting users to press F8 for CIMC Setup"]
...
None: `[X]`
+
image:express-c-series-c190-deploy_image6.png["A screenshot of Cisco IMC Configuration Utility NIC Properties with dedicated NIC and no redundancy selected"]
...
+
image:express-c-series-c190-deploy_image7.png["A screenshot of the Cisco Integrated Management Controller BIOS Configure Boot Order page"]
...
+
image:express-c-series-c190-deploy_image8.png["A screenshot of Advanced Boot Order Configuration with KVM-MAPPED-DVD, iSCSI-A, and iSCSI-B enabled"]
...
+
image:express-c-series-c190-deploy_image9.png["A screenshot that shows CIMC BIOS settings with PCIe Slot 1 and Slot 2 Option ROM disabled"]
...
+
image:express-c-series-c190-deploy_image10.png["A screenshot of Cisco Integrated Management Controller Adapter Card MLOM General tab with Port Channel unchecked"]
...
+
image:express-c-series-c190-deploy_image11.png["A screenshot that shows General settings for iSCSI vNIC eth1 with VLAN 3439 and uplink port 1"]

. Select the vNIC eth1 on the left.
+
image:express-c-series-c190-deploy_image12.png["A screenshot that shows iSCSI Boot Properties initiator settings for vNIC eth1"]
...
+
image:express-c-series-c190-deploy_image13.png["A screenshot of iSCSI boot properties with initiator, primary target, and secondary target details"]
...
+
image:express-c-series-c190-deploy_image14.png["A screenshot that shows iSCSI boot properties for vNIC eth3 with initiator and target settings"]
...
+
image:express-c-series-c190-deploy_image15.png["A screenshot of Cisco Integrated Management Controller vNIC eth0 properties with MTU 9000 and default VLAN 2"]

. Repeat steps 3 and 4 for eth1, verifying that the uplink port is set to 1 for eth1.
+
image:express-c-series-c190-deploy_image16.png["A screenshot of Cisco Integrated Management Controller vNICs listing eth0 through eth3 with MTU, uplink port, and VLAN settings"]
+
[NOTE]
