...
+
image:express-c-series-aff220-deploy_image8.png["A screenshot of a Cisco server boot screen prompting users to press F8 for CIMC setup"]
...
*** None: [X]
+
image:express-c-series-aff220-deploy_image9.png["A screenshot of Cisco IMC NIC Properties with IPv4 settings and no NIC redundancy selected"]
...
+
image:express-c-series-aff220-deploy_image10.png["A screenshot of Cisco IMC Configuration Utility showing common properties and port settings"]
...
+
image:express-c-series-aff220-deploy_image11.png["A screenshot of Cisco Integrated Management Controller BIOS settings with Configure Boot Order selected"]
...
+
image:express-c-series-aff220-deploy_image12.png["A screenshot of Advanced Boot Order Configuration with KVM-MAPPED-DVD, iSCSI-A, and iSCSI-B enabled"]
...
+
image:express-c-series-aff220-deploy_image13.png["A screenshot that shows CIMC BIOS settings with PCIe Slot 1 and Slot 2 Option ROM disabled"]
...
+
image:express-c-series-aff220-deploy_image14.png["A screenshot that shows iSCSI-vNIC-A settings with MTU 9000, VLAN 3439, trunk mode, and PXE boot enabled"]
...
+
image:express-c-series-aff220-deploy_image15.png["A screenshot that shows iSCSI-vNIC-A selected with expanded iSCSI Boot Properties on the vNICs tab"]
...
+
image:express-c-series-aff220-deploy_image16.png["A screenshot of Cisco UCS iSCSI Boot Properties showing initiator name, IP address, subnet mask, and gateway fields"]
...
+
image:express-c-series-aff220-deploy_image17.png["A screenshot that shows iSCSI vNIC initiator settings with primary and secondary NetApp targets"]
...
+
image:express-c-series-aff220-deploy_image18.png["A screenshot of the Cisco VIC vNICs tab listing eth0, eth1, and two iSCSI vNICs"]

. Select eth0 and click Properties.
. Set the MTU to 9000. Click Save Changes.
+
image:express-c-series-aff220-deploy_image19.png["A screenshot of Cisco VIC eth0 vNIC properties with the MTU field set to 9000"]

. Repeat steps 3 and 4 for eth1, verifying that the uplink port is set to `1` for eth1.
+
image:express-c-series-aff220-deploy_image20.png["A screenshot that shows the vNICs tab with eth0 and eth1 MTU set to 9000 and uplink ports 0 and 1"]
+
[NOTE]
