...
image:express-direct-attach-aff220-deploy_image2.png["A diagram that compares FlexPod Express, FlexPod Datacenter, and FlexPod Select solutions"]
...
image:express-direct-attach-aff220-deploy_image3.png["A diagram that shows FlexPod Express servers, Nexus switches, and AFF storage cabling for management, data, IP, cluster interconnect, and vPC peer networks"]
