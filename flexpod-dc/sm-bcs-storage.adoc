...
image:sm-bcs-image22.png["A diagram that shows an AFF A250 connected to Nexus A and Nexus B switches at two sites"]
...
image:sm-bcs-image23.png["A diagram that shows Nexus-connected AFF A250 controller ports, interface groups, VLAN ports, and LIFs"]
...
image:sm-bcs-image24.png["A diagram that shows redundant iSCSI SAN boot connectivity from B200 M5 servers to AFF A250 controllers"]
...
image:sm-bcs-image25.png["A screenshot of ONTAP System Manager Add Intercluster Interfaces dialog with two IP address fields"]

To peer the two clusters together, complete the following steps:

. Generate cluster peering passphrase in the first cluster.
+
image:sm-bcs-image26.png["A screenshot of the Generate Passphrase dialog with cluster peer permissions, validity, and a copied passphrase"]

. Invoke the Peer Cluster option in the second cluster and provide the passphrase and intercluster LIF information.
+
image:sm-bcs-image27.png["A screenshot that shows the ONTAP System Manager Peer Cluster dialog with passphrase and intercluster LIF addresses"]

. The System Manager Protection > Overview pane shows cluster peer information.
+
image:sm-bcs-image28.png["A screenshot of ONTAP System Manager Protection Overview showing cluster peer and mediator status"]
...
image:sm-bcs-image29.png["A screenshot of the ONTAP System Manager Configure Mediator dialog with mediator connection fields"]
...
image:sm-bcs-image30.png["A screenshot of the ONTAP System Manager Protection Overview pane showing configured Mediator status"]
...
image:sm-bcs-image31.png["A screenshot of the Protect Consistency Group dialog with source volume esxi_a and destination cluster aff-a250-b"]
...
image:sm-bcs-image32.png["A screenshot of ONTAP System Manager relationships showing two healthy, in-sync consistency groups at site A"]

This screenshot shows the consistency group relationships at site B.

image:sm-bcs-image33.png["A screenshot of ONTAP System Manager relationships at site B showing two healthy, in-sync consistency groups"]

This screenshot shows the consistency group relationship details for the cg_infra_datastore_b group.

image:sm-bcs-image34.png["A screenshot of ONTAP System Manager showing cg_infra_datastore_b consistency group relationship details"]
...
image:sm-bcs-image35.png["A screenshot of ONTAP volume information for Infra-SVM-a, including RW, DP, and LS volumes"]

This screenshot shows the volume information for site B.

image:sm-bcs-image36.png["A screenshot of the ONTAP volume show output for Infra-SVM-b listing nine volumes, including destination DP volumes"]
...
image:sm-bcs-image37.png["A screenshot that shows site A iSCSI igroups and LUN mappings in ONTAP CLI output"]

This screenshot shows the host igroups and LUN mapping for site B cluster.

image:sm-bcs-image38.png["A screenshot of site B igroup and LUN mapping command output for iSCSI VMware hosts"]
