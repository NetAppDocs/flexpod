...
image:sm-bcs-image39.png["A diagram that shows VMware HA and vSphere Metro Storage Cluster across FlexPod sites A and B via a multi-site fabric"]
...
image:sm-bcs-image40.png["A diagram that shows Cisco UCS B200 M5 servers and AFF A250 storage at Sites A and B connected through Nexus switches and an ONTAP Mediator at Site C"]
...
image:sm-bcs-image41.png["A diagram that shows vSwitch0, vDS0, iSCSI-A, and iSCSI-B switches with six vNIC uplinks"]
...
image:sm-bcs-image42.png["A screenshot that shows VM/Host Groups for Site A and Site B hosts and VMs in vSphere"]
...
image:sm-bcs-image43.png["A screenshot of the Edit VM/Host Rule dialog configuring Site A VMs to run on Site A hosts"]

image:sm-bcs-image44.png["A screenshot of the Edit VM/Host Rule dialog for Site B VMs and hosts with a Should run on hosts in group policy"]
...
image:sm-bcs-image45.png["A screenshot of vSphere HA advanced options with four heartbeat datastores and two isolation addresses configured"]
...
image:sm-bcs-image46.png["A screenshot of vSphere HA Heartbeat Datastores settings with four specified datastores selected"]

For additional best practices and configurations for VMware HA Cluster and VMware vSphere Metro storage cluster, see https://docs.vmware.com/en/VMware-vSphere/7.0/com.vmware.vsphere.avail.doc/GUID-5432CA24-14F1-44E3-87FB-61D937831CF6.html[Creating and Using vSphere HA Clusters^], https://core.vmware.com/resource/vmware-vsphere-metro-storage-cluster-vmsc[VMware vSphere Metro Storage Cluster (vMSC)^] and https://docs.netapp.com/us-en/netapp-solutions-virtualization/vmware/vmw-vmsc-with-smas.html[NetApp ONTAP with SnapMirror active sync (formerly SM-BC) and VMware vSphere Metro Storage Cluster (vMSC)^].
