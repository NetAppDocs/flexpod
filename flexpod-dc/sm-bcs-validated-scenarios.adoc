...
image:sm-bcs-image47.png["A diagram that shows ESXi iSCSI paths through two fabrics to primary and destination consistency group LUNs"]
...
image:sm-bcs-image48.png["A screenshot of ESXi Storage Adapters Paths tab showing two Active (I/O) and six Active iSCSI paths"]
...
image:sm-bcs-image49.png["A screenshot of the vSphere Client showing six iSCSI datastores mounted on host esxi-a-01.nva.local"]
...
image:sm-bcs-image50.png["A screenshot of vSphere migration storage selection for iometer-a-01 with iSCSI datastores from sites A and B"]
...
+
image:sm-bcs-image51.png["A screenshot of ONTAP System Manager Relationships with the source options menu showing Failover"]

. Confirm failover for the action to start.
+
image:sm-bcs-image52.png["A screenshot of ONTAP System Manager Planned Failover confirmation for cg_esxi_a from Infra-SVM.1 to Infra-SVM-b"]
...
image:sm-bcs-image53.png["A screenshot of ONTAP System Manager showing site A performance graphs with reduced IOPS and throughput"]
...
image:sm-bcs-image54.png["A screenshot of the ONTAP System Manager dashboard showing performance at 132.99K IOPS and 1,038.58 MB/s throughput"]
...
image:sm-bcs-image55.png["A screenshot of ONTAP System Manager Relationships showing healthy, in-sync consistency groups and a Failover menu option"]
...
image:sm-bcs-image56.png["A diagram that shows Site A storage unavailable and SM-BC data services continuing at Site B via ONTAP Mediator"]
...
image:sm-bcs-image57.png["A screenshot of the ONTAP System Manager dashboard showing 80.32k IOPS and 626.98 MB/s throughput"]

image:sm-bcs-image58.png["A screenshot of ONTAP System Manager dashboard for aff-a250-b showing 81.37k IOPS and 635.41 MB/s throughput"]
...
image:sm-bcs-image59.png["A screenshot of ONTAP System Manager showing sharply increased IOPS and throughput performance on cluster aff-a250-b"]
...
image:sm-bcs-image60.png["A screenshot of ONTAP System Manager relationships showing two healthy relationships out of sync"]
...
image:sm-bcs-image61.png["A screenshot that shows ONTAP System Manager relationships with healthy status and in-sync state"]
...
image:sm-bcs-image62.png["A screenshot of the Edit VM/Host Rule dialog assigning Site A VMs to the Site B hosts group"]
...
image:sm-bcs-image63.png["A screenshot of two BMC CLI windows showing system power off commands for aff-a250-a-01 and aff-a250-a-02"]
...
image:sm-bcs-image64.png["A screenshot of a Grafana dashboard showing SVM latency, throughput, and IOPS metrics for Infra-SVM on cluster aff-a250-a"]

image:sm-bcs-image65.png["A screenshot of the Grafana SVM dashboard showing latency, throughput, and IOPS graphs for Infra-SVM-b"]
...
image:sm-bcs-image66.png["A screenshot of Microsoft SQL Server TPROC-C Build Options with 100 warehouses and 10 virtual users"]
...
image:sm-bcs-image67.png["A screenshot of HammerDB Transaction Counter showing a brief transaction drop and recovery during TPROC-C creation"]
...
image:sm-bcs-image68.png["A screenshot of the NAbox Grafana dashboard showing site B storage cluster latency, throughput, and IOPS metrics dropping to zero"]
...
image:sm-bcs-image69.png["A screenshot of the NAbox Grafana dashboard showing site A SVM latency, throughput, and IOPS metrics"]
