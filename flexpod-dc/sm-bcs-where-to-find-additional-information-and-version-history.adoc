...
+
https://www.vmware.com/docs/vmw-vmware-vsphere-metro-storage-cluster-recommended-practices[https://www.vmware.com/docs/vmw-vmware-vsphere-metro-storage-cluster-recommended-practices^]

* NetApp ONTAP with SnapMirror active sync (formerly SM-BC) with VMware vSphere Metro Storage Cluster (vMSC)
+
https://docs.netapp.com/us-en/netapp-solutions-virtualization/vmware/vmw-vmsc-with-smas.html[https://docs.netapp.com/us-en/netapp-solutions-virtualization/vmware/vmw-vmsc-with-smas.html^]
