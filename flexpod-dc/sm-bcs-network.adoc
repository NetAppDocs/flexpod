...
image:sm-bcs-image20.png["A diagram that shows FI 6454, Nexus, and AFF A250 redundant local connectivity"]
...
image:sm-bcs-image21.png["A diagram that shows vPC peer links and inter-site links between FlexPod switches at sites A and B"]
