...
image:sm-bcs-image17.png["A diagram that shows UCS 2204XP A and B connected to a B200 M5 VIC over 10GBASE-KR"]
...
image:sm-bcs-image18.png["A diagram that shows UCS 5108 IOMs connected to FI 6454 switches and Nexus A and B switches"]
...
image:sm-bcs-image19.png["A screenshot that shows the Cisco UCS Manager Set iSCSI Boot Parameters dialog with two static targets configured"]
