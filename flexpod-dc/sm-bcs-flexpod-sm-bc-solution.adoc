...
image:sm-bcs-image4.png["A diagram that shows FlexPod sites A and B connected with up to 10 ms latency and an ONTAP Mediator at site C"]
...
image:sm-bcs-image5.png["A diagram that shows Cisco UCS C240/C245, C220/C225, B200, and X210c M6 servers"]
...
image:sm-bcs-image6.png["A diagram that shows front views of UCS 2408, 2304, 2208XP, 2204XP, and UCSX 9108 modules"]
...
image:sm-bcs-image7.png["A diagram that shows front panels of Cisco UCS FI 6454, 64108, 6324, 6332, and 6332-16UP models"]
...
image:sm-bcs-image8.png["A diagram that shows Cisco UCS VIC 1440, 1467, 1455, 1480, 1477, 1457, 14825, 14425, and 14000 bridge cards"]
...
image:sm-bcs-image9.png["A diagram that shows Cisco Nexus 9336C-FX2, 93180YC-FX3, and 3232C switches"]
...
image:sm-bcs-image10.png["A diagram that shows front views of Cisco MDS 9132T, 9148T, 9148S, 9250i, and 9396T switches"]
...
image:sm-bcs-image11.png["A diagram that shows NetApp AFF and ASA controllers and DS 224C/2246 and NS 224 disk shelves"]
...
image:sm-bcs-image12.png["A diagram that shows two FlexPod sites with SM-BC relationships and an ONTAP Mediator at Site C"]
...
image:sm-bcs-image13.png["A diagram that shows asymmetric FlexPod sites connected by extended Layer 2 links and ONTAP Mediator"]
...
image:sm-bcs-image14.png["A diagram that shows Intersight- and UCSM-managed FlexPod sites connected through a VXLAN multi-site fabric with SM-BC relationships"]
...
image:sm-bcs-image15.png["A diagram that shows FlexPod branch sites connected to a datacenter through a VXLAN multi-site fabric and ONTAP Mediator"]
