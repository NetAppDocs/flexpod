...
image:sm-bcs-image2.png["A diagram that shows FlexPod Datacenter components: Cisco UCS, Nexus/MDS switches, and NetApp AFF/FAS/ASA storage"]
...
image:sm-bcs-image3.png["A diagram that shows SnapMirror Synchronous replication and automated failover between primary and secondary datacenters"]
