...
image:security-ransomware_image3.png[]

The following screenshot shows the CIFS share that was mapped to the VM.

image:security-ransomware_image4.png[]
...
image:security-ransomware_image5.png[]
...
+
image:security-ransomware_image10.png[]

. The binary was executed.
+
image:security-ransomware_image11.png[]
...
image:security-ransomware_image12.png[]

The malware encrypts all the files in the local VM and the mapped share.

image:security-ransomware_image13.png[]
...
+
image:security-ransomware_image17.png[]

. Select the desired VMware- consistent Snapshot copy for restore.
+
image:security-ransomware_image18.png[]

. The entire VM is restored and restarted.
+
image:security-ransomware_image19.png[]

. Click Finish to start the restore process.
+
image:security-ransomware_image20.png[]

. The VM and its files are restored.
+
image:security-ransomware_image21.png[]
...
+
image:security-ransomware_image22.png[]

. Click OK to initiate the restore operation.
+
image:security-ransomware_image23.png[]

. View the CIFS share after the restore.
+
image:security-ransomware_image24.png[]
...
image:security-ransomware_image25.png[]
...
image:security-ransomware_image26.png[]
