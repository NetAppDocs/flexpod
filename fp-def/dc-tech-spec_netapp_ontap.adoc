...
[.lead]
NetApp ONTAP software is installed on all NetApp FAS, AFF, and ASA systems. FlexPod is validated with ONTAP software, providing a highly scalable storage architecture that enables non-disruptive operations, non-disruptive upgrades, and an agile data infrastructure.
