...
Refer to link:https://www.cisco.com/c/en/us/td/docs/unified_computing/ucs/UCS_CVDs/flexpod_base_imm_manual_deploy.html#FlexPod_Cisco_Nexus_SAN_Switch_Part1[this^] link for more information on this configuration.
