...
image:dc-tech-spec_image10.png[]
...
For more information about ONTAP implementation, see https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf[TR-4684: Implementing and Configuring Modern SANs with NVMe^].

image:dc-tech-spec_image3.png[]
...
image:dc-tech-spec_image4.jpg[]

image:dc-tech-spec_image5.png[]
