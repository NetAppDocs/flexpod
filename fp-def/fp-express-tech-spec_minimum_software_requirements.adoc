...
[NOTE]
All of the software versions listed in this section are the minimum requirements for the hardware components (NetAPP Components and the Cisco components) listed in the subsequent sections of the document. 
