...
[NOTE]
Switchless cluster configuration is supported only for a two node configuration. Cluster interconnect switches are required for configurations with more than 4 nodes, and optional for a two node configurations. 
...
.3+|AFF A-Series
|A250 
.3+|https://www.netapp.com/pdf.html?item=/media/7828-ds-3582-aff-a-series-ai-era.pdf[AFF A-Series Documentation]
|A20
|A30
|AFF C-Series
|C30
