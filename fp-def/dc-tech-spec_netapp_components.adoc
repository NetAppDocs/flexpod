...
For more information about the disk shelves and storage media, see the Disk Shelves and Storage Media Technical Specifications link in the following table.
...
|DS224C
.4+|
https://www.netapp.com/data-storage/disk-shelves-storage-media/[Disk Shelves and Storage Media Technical Specifications]
|DS212C
|DS460C
|NS224
|===
