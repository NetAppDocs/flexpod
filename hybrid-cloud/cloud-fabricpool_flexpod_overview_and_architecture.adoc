...
image:cloud-fabricpool_image2.png["A diagram that shows FlexPod storage, Cisco Nexus and MDS switches, and Cisco UCS families with connectivity guidance"]
...
image:cloud-fabricpool_image3.png["A diagram that shows Cisco UCS, Nexus 93180YC-EX, AFF A300, and MDS 9148S connections"]
