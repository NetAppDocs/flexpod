...
+
image:cloud-fabricpool_image14.png["A screenshot that shows the OnCommand System Manager navigation menu with Applications & Tiers selected"]

. Click Storage Tiers.
. Click an aggregate.
. Click Actions and select Attach Cloud Tier.
+
image:cloud-fabricpool_image15.png["A screenshot that shows the More Actions menu with Attach Cloud Tier selected"]
