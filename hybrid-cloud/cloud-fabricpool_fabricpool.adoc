...
image:cloud-fabricpool_image4.png["A diagram that shows Snapshot-Only tiering moving snapshot copies from a primary cluster to cloud storage"]
...
image:cloud-fabricpool_image5.png["A diagram that shows Auto tiering moving inactive data from primary cluster storage to cloud storage"]
