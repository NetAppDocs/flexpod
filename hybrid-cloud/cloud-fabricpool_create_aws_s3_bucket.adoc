...
image:cloud-fabricpool_image10.png["A diagram that shows valid and invalid FabricPool aggregate-to-bucket attachment configurations"]
...
+
image:cloud-fabricpool_image11.png["A screenshot of the AWS console search showing the S3 Scalable Storage in the Cloud result highlighted"]

. On the S3 home page, select Create Bucket.
. Enter a DNS-compliant name and choose the region to create the bucket.
+
image:cloud-fabricpool_image12.png["A screenshot of the AWS Create bucket dialog with bucket name, region, and Create button"]
