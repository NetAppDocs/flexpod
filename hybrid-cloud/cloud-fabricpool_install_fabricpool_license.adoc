...
image:cloud-fabricpool_image8.png["A screenshot of OnCommand System Manager Add License Packages dialog with Choose Files and Add buttons"]
...
image:cloud-fabricpool_image9.png["A screenshot of ONTAP System Manager Licenses details showing FabricPool License capacity of 10 TB and current capacity of 0 Byte"]
