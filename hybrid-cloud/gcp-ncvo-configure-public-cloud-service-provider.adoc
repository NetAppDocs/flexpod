...
To access NetApp cloud services, sign up and log in using the https://console.netapp.com[NetApp Console^].

[NOTE]
For setting up workspaces and users in the NetApp Console account, click https://docs.netapp.com/us-en/occm/task_setting_up_cloud_central_accounts.html[here^].
