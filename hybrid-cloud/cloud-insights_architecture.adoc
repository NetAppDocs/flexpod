...
image:cloud-insights_image2.png["A diagram that shows Cisco UCS, Nexus switches, NetApp AFF A800 controllers, and MDS switches interconnected by network links"]
...
* Analyzing the environment with data provided to NetApp Digital Advisor for assessment of storage system risks and recommendations for storage optimization.
