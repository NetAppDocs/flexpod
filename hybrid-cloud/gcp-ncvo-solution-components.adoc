...
More information about Intersight Licensing and features supported in each licensing can be found https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra[here^].
...
After claiming Intersight Assist into Intersight, you can claim endpoint devices using the Claim Through Intersight Assist option. For more information, see https://intersight.com/help/saas/getting_started/overview[Getting Started^].
