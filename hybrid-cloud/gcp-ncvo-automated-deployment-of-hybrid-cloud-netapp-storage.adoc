...
https://github.com/ucs-compute-solutions/cvo_snapmirror[This GitHub link^] provides the Terraform configuration with various resources. You can fork this repository and make a copy in your GitHub account.
