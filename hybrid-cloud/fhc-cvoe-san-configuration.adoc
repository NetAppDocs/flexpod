...
. In Systems, select the system that contains the source volume, drag it to the system to which you want to replicate the volume, and then select *Replication*.
+
image:fhc-cvoe-image8.jpeg["This screenshot shows the NetApp Console Systems screen with Replication selected in a drop-down for the On-prem ONTAP instance."]
+
...
+
image:fhc-cvoe-image9.png["This screenshot shows the Console Source Peering Setup screen."]

. *Source Volume Selection.* Select the volume that you want to replicate.
+
image:fhc-cvoe-image10.jpeg["This screenshot shows the Console Source Volume Selection screen with one volume of fourteen displayed."]
...
+
image:fhc-cvoe-image11.jpeg["This screenshot shows the Console Destination Disk Type screen with General Purpose SSD selected."]
...
+
image:fhc-cvoe-image12.jpeg["This screenshot shows the Console Destination volume name screen with the relevant information entered."]

. *Max transfer rate.* Specify the maximum rate (in megabytes per second) at which data can be transferred.
+
image:fhc-cvoe-image13.jpeg["This screenshot shows the Console Max Transfer Rate screen with 100 MB/s entered."]
...
+
image:fhc-cvoe-image14.jpeg["This screenshot shows the Console Replication Policy page with the Default policies of Mirror or Mirror and Backup displayed."]
...
+
image:fhc-cvoe-image15.jpeg["This screenshot shows the Console Replication Setup schedule screen with multiple timing options displayed."]

. *Review.* Review your selections and click *Go*.
+
image:fhc-cvoe-image16.jpeg["This screenshot shows the Console Replication Setup Review and Approve screen."]
...
The Console starts the data replication process. Now, you can see the *Replication* service that was established between your on-premises ONTAP system and Cloud Volumes ONTAP.

image:fhc-cvoe-image17.jpeg["This screenshot shows the Console Systems screen with the Replication service depicted as a line between the CVO instance and the on-premises ONTAP instance."]

In the Cloud Volumes ONTAP cluster, you can see the newly created volume.

image:fhc-cvoe-image18.png["This screenshot shows the Console Volumes tab with the new volume displayed."]

You can also verify that the SnapMirror relationship is established between the on-premises volume and the cloud volume.

image:fhc-cvoe-image19.jpeg["This screenshot shows the Console Replications tab with information concerning the replication relationship just created."]
