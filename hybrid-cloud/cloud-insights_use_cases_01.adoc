...
Cloud Insights is fully integrated into the Digital Advisor storage monitoring platform. An ONTAP system, deployed as a part of a FlexPod Datacenter solution, is automatically configured to send information back to NetApp through the AutoSupport function, which is built into each system. These reports are generated on a scheduled basis, or dynamically whenever a fault is detected in the system. The data communicated through AutoSupport is aggregated and displayed in easily accessible dashboards under the Digital Advisor menu in Cloud Insights.

=== Access Digital Advisor information through the Cloud Insights dashboard

To access the Digital Advisor information through the Cloud Insights dashboard, complete the following steps:
...
+
image:cloud-insights_image23.png["A screenshot that shows the Data Collectors page filtered for FlexPod Datacenter"]

. Click the Data Collector to get a summary of the environment and devices that are being monitored by that collector.
+
image:cloud-insights_image24.png["A screenshot of the FlexPod Datacenter data collector summary with event timeline and reported storage device"]
+
...
** Average Throughput
+
image:cloud-insights_image25.png["A screenshot of the aa14-a800 storage dashboard with summary, risks, user data, and latency chart"]
+
Also, on this page under the Performance Policies section, you can find a link to NetApp Digital Advisor.
+
image:cloud-insights_image26.png["A screenshot that shows Performance Policies with 35 risks detected by Active IQ and an external link icon"]

. To open a new browser tab and take you to the risk mitigation page, which shows which nodes are affected, how critical the risks are, and what the appropriate action is that needs to be taken to correct the identified issues, click the link for Digital Advisor.
+
image:cloud-insights_image27.png["A screenshot of Active IQ Digital Advisor listing health risks and corrective actions for a storage system"]
...
image:cloud-insights_image28.png["A screenshot of Cloud Insights Data Collector details showing successful acquisition 3 minutes ago at 1:21 PM"]
...
image:cloud-insights_image29.png["A screenshot of Cloud Insights Expert View with latency, IOPS, and throughput graphs and resource details"]
...
image:cloud-insights_image30.png["A screenshot of the storage dashboard with the time range dropdown showing Last 15 Minutes through Custom"]
...
+
image:cloud-insights_image31.png["A screenshot of the Cloud Insights Dashboards menu with + New Dashboard highlighted"]
+
...
+
image:cloud-insights_image32.png["A screenshot of the New Dashboard widget type selection tiles, including charts, gauges, notes, and tables"]
...
+
image:cloud-insights_image33.png["A screenshot that shows the Add Variable menu with a search field and variable list on a new dashboard"]
...
+
image:cloud-insights_image34.png["A screenshot that shows a Capacity Used pie chart widget configured for storage volume capacity used"]
+
