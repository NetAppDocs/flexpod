...
* Updated list of NetApp storage tasks available within Cisco Intersight. See link:ontap-connector-for-intersight/ci-qsg_use_cases.html#use-case-3:-custom-workflows-using-designer-free-form[Use case 3: Custom workflows using designer-free form for a complete list of NetApp storage tasks].
