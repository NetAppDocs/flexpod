...
Install or upgrade to Active IQ Unified Manager 9.10GA or later if you have not done so. For instructions, go to the link:http://docs.netapp.com/ocum-98/index.jsp[Unified Manager 9.8 Documentation Center].
