...
Install or upgrade to Active IQ Unified Manager (latest version is required, currently 9.11 GA) if you have not done so. For instructions, go to the link:https://docs.netapp.com/us-en/active-iq-unified-manager/[NetApp Active IQ Unified Manager Documentation].
