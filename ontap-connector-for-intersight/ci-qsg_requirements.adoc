...
[NOTE]
Refer to https://intersight.com/help/saas/supported_systems/overview[Cisco Intersight supported systems^] for the minimum requirements of Cisco UCS Compute Components and UCSM version.
...
For more information about the features covered by various licensing tiers, go to https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra[Infrastructure Services license^].
