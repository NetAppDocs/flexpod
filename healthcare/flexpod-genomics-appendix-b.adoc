...
summary: This section describes the execution of the ./gatk output.
---
...
//
// 2021-11-04 14:24:47.718231
//

link:flexpod-genomics-appendix-a.html[Previous: Output for execution of GATK using the jar file.]

The execution of GATK using the `./gatk` script produces the following output.
...
link:flexpod-genomics-appendix-c.html[Next: Output for execution of GATK using the Cromwell engine.]
