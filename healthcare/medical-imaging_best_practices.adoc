...
image:medical-imaging_image8.png[]
...
* Use the NetApp storage-array-based replication technology called https://www.netapp.com/pdf.html?item=/media/17229-tr4015pdf.pdf[SnapMirror^] instead of vSphere-based replication.
