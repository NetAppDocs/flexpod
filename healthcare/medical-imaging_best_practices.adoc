...
image:medical-imaging_image8.png["A diagram that shows AFF A300 nodes with a0a ifgrps, VLANs, and NFS and iSCSI LIFs"]
...
* Use the NetApp storage-array-based replication technology called https://www.netapp.com/pdf.html?item=/media/17229-tr4015.pdf[SnapMirror^] instead of vSphere-based replication.
