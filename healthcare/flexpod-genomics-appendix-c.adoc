...
summary: This section shows the output after executing GATK using the Cromwell engine.
---
...
//
// 2021-11-04 14:24:47.729917
//

link:flexpod-genomics-appendix-b.html[Previous: Output for execution of GATK using the `./gatk` script.]

The execution of GATK using the Cromwell engine produces the following output.
...
link:flexpod-genomics-appendix-d--gpu-setup.html[Next: GPU setup.]
