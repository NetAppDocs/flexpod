...
* *Storage efficiency.* Reduce storage costs with the https://www.netapp.com/media/79014-ng-937-Efficiency-Guarantee-Customer-Flyer.pdf[NetApp 7:1 storage efficiency guarantee^].
