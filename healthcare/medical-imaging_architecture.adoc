...
image:medical-imaging_image3.png[]
...
image:medical-imaging_image4.png[]
...
image:medical-imaging_image5.png[]
...
image:medical-imaging_image6.png[]

The figure below shows the physical application components.

image:medical-imaging_image7.png[]
