...
image:medical-imaging_image3.png["A diagram that shows FlexPod medical imaging infrastructure with UCS, Nexus, AFF, and MDS switches"]
...
image:medical-imaging_image5.png["A diagram that shows a community clinic connected to hospital systems through an enterprise service bus"]
...
image:medical-imaging_image6.png["A diagram that shows layered medical imaging components on FlexPod with replicated disaster recovery"]

The figure below shows the physical application components.

image:medical-imaging_image7.png["A diagram that shows active and standby FlexPod data centers with NetApp ONTAP storage and medical imaging servers"]
