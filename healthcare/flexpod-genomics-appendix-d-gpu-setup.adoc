...
+
image:flexpod-genomics-image18.png["A screenshot of Cisco UCS Manager Inventory GPUs tab showing a P6 graphics card in Compute mode"]
+
image:flexpod-genomics-image19.png["A screenshot of Cisco UCS Manager showing GPU inventory with a UCSB-GPU-P6-R in Compute mode"]
...
. This command installs the https://docs.nvidia.com/vgpu/latest/grid-software-quick-start-guide/installing-configuring-vgpu-manager-guest-driver.html#installing-the-nvidia-virtual-gpu-manager-on-vmware-vsphere[NVIDIA vGPU Manager^] in ESXi.
+
....
...
+
image:flexpod-genomics-image20.png["A screenshot of vSphere Client showing NVIDIA Tesla P6 graphics device configured for Shared Direct"]
+
image:flexpod-genomics-image21.png["A screenshot of Edit Graphics Device Settings with Shared Direct selected and Restart X.Org server checked"]
...
+
image:flexpod-genomics-image22.png["A screenshot of vCenter VM Boot Options showing EFI firmware and Secure Boot disabled"]
...
+
image:flexpod-genomics-image23.png["A screenshot that shows the vCenter Edit Settings Advanced section with an Edit Configuration link"]
+
image:flexpod-genomics-image24.png["A screenshot of the Configuration Parameters dialog listing pciPassthru.64bitMMIOSizeGB and pciPassthru.use64bitMMIO values"]
...
+
image:flexpod-genomics-image25.png["A screenshot of vCenter Edit Settings showing NVIDIA GRID vGPU profile grid_p6-16c selected for a PCI device"]
...
+
image:flexpod-genomics-image26.png["A screenshot of the NVIDIA License Server Licensed Clients page listing one virtual Ethernet client"]
