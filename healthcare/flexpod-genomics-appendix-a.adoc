...
summary: This section provides the jar file output from GATK.
---
...
//
// 2021-11-04 14:24:47.710941
//

link:flexpod-genomics-genomics---gatk-setup-and-execution.html[Previous: Genomics - GATK setup and execution.]

Execution of GATK using the jar file output below.
...
link:flexpod-genomics-appendix-b.html[Next: Output for execution of GATK using the `./gatk` script.]
