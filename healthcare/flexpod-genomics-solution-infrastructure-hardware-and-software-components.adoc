...
image:flexpod-genomics-image6.png["A diagram that shows FlexPod for Genomics with Cisco UCS, Nexus, MDS, and NetApp AFF A700 connectivity"]

The following diagram depicts the FlexPod cabling details.

image:flexpod-genomics-image7.png["A diagram that shows FlexPod for Genomics cabling between UCS, Nexus, NetApp AFF, and MDS switches"]
