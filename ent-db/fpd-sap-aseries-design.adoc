...
= FlexPod Datacenter for SAP Solution with Cisco UCS 3rd generation Fabric and NetApp AFF A–Series - Deployment
...
link:https://www.cisco.com/c/en/us/td/docs/unified_computing/ucs/UCS_CVDs/flexpod_sap_ontap96.html[FlexPod Datacenter for SAP Solution with Cisco UCS 3rd generation Fabric and NetApp AFF A–Series - Deployment^]